...
Ball.prototype.update = function(paddle1, paddle2) {
  ...
  } else if(this.x + 5 > 600) { // right
    this.x = 595;
    this.x_speed = -this.x_speed;
  }

  if(this.y < 0 || this.y > 600) { // score (top/bottom)
    this.x_speed = 0;
    this.y_speed = 3;
    this.x = 300;
    this.y = 300;
...
Paddle.prototype.move = function(x, y) {
  ...
  this.x_speed = x;
  this.y_speed = y;
  if(this.x < 0) { // paddle can't pass the leftmost wall
    this.x = 0;
    this.x_speed = 0;
  } else if (this.x + this.width > 600) { // paddle can't pass the leftmost wall
